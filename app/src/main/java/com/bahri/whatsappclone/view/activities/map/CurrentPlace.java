package com.bahri.whatsappclone.view.activities.map;
...
public class CurrentPlace extends AppCompatActivity implements OnMapReadyCallback {
     ...
     * we just add a marker near Sfax, Tunisia.
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker in Sfax, Tunisia and move the camera
        LatLng sydney = new LatLng(30, 10);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Marker in Sfax"));
