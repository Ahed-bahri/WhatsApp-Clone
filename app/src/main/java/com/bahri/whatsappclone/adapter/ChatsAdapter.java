package com.bahri.whatsappclone.adapter;
...
import com.bahri.whatsappclone.tools.AudioService;
                ...
                case "VOICE" :
                    ...
                    layoutVoice.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (tmpBtnPlay!=null){
                                tmpBtnPlay.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_play_circle_filled_black_24dp));
                            }

                            btnPlay.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_pause_circle_filled_black_24dp));
                            audioService.playAudioFromUrl(chats.getUrl(), new AudioService.OnPlayCallBack() {
                                @Override
                                public void onFinished() {
                                    btnPlay.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_play_circle_filled_black_24dp));
                                }
                            });
