...
import com.bahri.whatsappclone.view.activities.chats.ChatsActivity;
import com.bahri.whatsappclone.view.activities.dialog.DialogViewUser;
...
public class ChatListAdapter extends RecyclerView.Adapter<ChatListAdapter.Holder> {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        if (chatlist.getUrlProfile().equals("")){
            holder.profile.setImageResource(R.drawable.personholder);
        } else {
